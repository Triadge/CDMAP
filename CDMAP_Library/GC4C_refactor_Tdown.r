...
Path_BaseSubstitution_output_current <- Path_BaseSubstitution_output_downT
#Path_text_output_current <- paste(Path_text_output_down, "/T", sep = "")
...
Path_MutationRates_output <- paste(Path_MutationRates_output, "/T", sep = "")
dir.create(Path_MutationRates_output)

Path_graphical_output_down_current <- paste(Path_graphical_output_down, "/T", sep = "")
...
Path_correlate_Chromosome_current <- paste(Path_correlate_Chromosome_down, "/T", sep = "")
dir.create(Path_correlate_Chromosome_current)

Path_correlate_Lcore_current <- paste(Path_correlate_Lcore_down, "/T", sep = "")
dir.create(Path_correlate_Lcore_current)
Path_correlate_Rcore_current <- paste(Path_correlate_Rcore_down, "/T", sep = "")
dir.create(Path_correlate_Rcore_current)

Path_correlate_Lcore_Replichore_current <- paste(Path_correlate_Lcore_replichore_down, "/T", sep = "")
dir.create(Path_correlate_Lcore_Replichore_current)
Path_correlate_Rcore_Replichore_current <- paste(Path_correlate_Rcore_replichore_down, "/T", sep = "")
dir.create(Path_correlate_Rcore_Replichore_current)
#======================================================#

#======== Bottom strand correlation directories ==========#
Path_correlate_RevComp_Chromosome_current <- paste(Path_correlate_RevComp_Chromosome_down, "/T", sep = "")
dir.create(Path_correlate_RevComp_Chromosome_current)

Path_correlate_RevComp_Lcore_current <- paste(Path_correlate_RevComp_Lcore_down, "/T", sep = "")
dir.create(Path_correlate_RevComp_Lcore_current)
Path_correlate_RevComp_Lcore_Replichore_current <- paste(Path_correlate_RevComp_Lcore_Replichore_down, "/T", sep = "")
dir.create(Path_correlate_RevComp_Lcore_Replichore_current)

Path_correlate_RevComp_Rcore_current <- paste(Path_correlate_RevComp_Rcore_down, "/T", sep = "")
dir.create(Path_correlate_RevComp_Rcore_current)
Path_correlate_RevComp_Rcore_Replichore_current <- paste(Path_correlate_RevComp_Rcore_Replichore_down, "/T", sep = "")
...
GWTC_Current <- GC4C_Tdown
GWTC_Left_Current <- GC4C_Tdown_Left
GWTC_Right_Current <- GC4C_Tdown_Right
Rev_GWTC_Current <- GC4C_Tdown_Comp
Rev_GWTC_Left_Current <- GC4C_Tdown_Left_Comp
Rev_GWTC_Right_Current <- GC4C_Tdown_Right_Comp

Mut_Matrix_Total <- Tdown_Mut_Matrix_Total
Mut_Matrix_Left <- Tdown_Mut_Matrix_Left
Mut_Matrix_Right <- Tdown_Mut_Matrix_Right
Comp_Mut_Matrix_Total <- Tdown_Comp_Mut_Matrix_Total
Comp_Mut_Matrix_Left <- Tdown_Comp_Mut_Matrix_Left
Comp_Mut_Matrix_Right <- Tdown_Comp_Mut_Matrix_Right


## Data Validation to prevent NaN coercion into mutation rates ##
