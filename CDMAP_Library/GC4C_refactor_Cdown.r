...
Path_BaseSubstitution_output_current <- Path_BaseSubstitution_output_downC
#Path_text_output_current <- paste(Path_text_output_down, "/C", sep = "")
...
Path_graphical_output_down_current <- paste(Path_graphical_output_down, "/C", sep = "")
...
Path_correlate_Chromosome_current <- paste(Path_correlate_Chromosome_down, "/C", sep = "")
dir.create(Path_correlate_Chromosome_current)

Path_correlate_Lcore_current <- paste(Path_correlate_Lcore_down, "/C", sep = "")
dir.create(Path_correlate_Lcore_current)
Path_correlate_Rcore_current <- paste(Path_correlate_Rcore_down, "/C", sep = "")
dir.create(Path_correlate_Rcore_current)

Path_correlate_Lcore_Replichore_current <- paste(Path_correlate_Lcore_replichore_down, "/C", sep = "")
dir.create(Path_correlate_Lcore_Replichore_current)
Path_correlate_Rcore_Replichore_current <- paste(Path_correlate_Rcore_replichore_down, "/C", sep = "")
dir.create(Path_correlate_Rcore_Replichore_current)
#======================================================#

#======== Bottom strand correlation directories ==========#
Path_correlate_RevComp_Chromosome_current <- paste(Path_correlate_RevComp_Chromosome_down, "/C", sep = "")
dir.create(Path_correlate_RevComp_Chromosome_current)

Path_correlate_RevComp_Lcore_current <- paste(Path_correlate_RevComp_Lcore_down, "/C", sep = "")
dir.create(Path_correlate_RevComp_Lcore_current)
Path_correlate_RevComp_Lcore_Replichore_current <- paste(Path_correlate_RevComp_Lcore_Replichore_down, "/C", sep = "")
dir.create(Path_correlate_RevComp_Lcore_Replichore_current)

Path_correlate_RevComp_Rcore_current <- paste(Path_correlate_RevComp_Rcore_down, "/C", sep = "")
dir.create(Path_correlate_RevComp_Rcore_current)
Path_correlate_RevComp_Rcore_Replichore_current <- paste(Path_correlate_RevComp_Rcore_Replichore_down, "/C", sep = "")
...
GWTC_Current <- GC4C_Cdown
GWTC_Left_Current <- GC4C_Cdown_Left
GWTC_Right_Current <- GC4C_Cdown_Right
Rev_GWTC_Current <- GC4C_Cdown_Comp
Rev_GWTC_Left_Current <- GC4C_Cdown_Left_Comp
Rev_GWTC_Right_Current <- GC4C_Cdown_Right_Comp

Mut_Matrix_Total <- Cdown_Mut_Matrix_Total
Mut_Matrix_Left <- Cdown_Mut_Matrix_Left
Mut_Matrix_Right <- Cdown_Mut_Matrix_Right
Comp_Mut_Matrix_Total <- Cdown_Comp_Mut_Matrix_Total
Comp_Mut_Matrix_Left <- Cdown_Comp_Mut_Matrix_Left
Comp_Mut_Matrix_Right <- Cdown_Comp_Mut_Matrix_Right
