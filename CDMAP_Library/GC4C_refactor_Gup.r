...
Path_BaseSubstitution_output_current <- Path_BaseSubstitution_output_upG
#Path_text_output_current <- paste(Path_text_output_up, "/G", sep = "")
...
Path_graphical_output_up_current <- paste(Path_graphical_output_up, "/G", sep = "")
...
Path_correlate_Chromosome_current <- paste(Path_correlate_Chromosome_up, "/G", sep = "")
dir.create(Path_correlate_Chromosome_current)

Path_correlate_Lcore_current <- paste(Path_correlate_Lcore_up, "/G", sep = "")
dir.create(Path_correlate_Lcore_current)
Path_correlate_Rcore_current <- paste(Path_correlate_Rcore_up, "/G", sep = "")
dir.create(Path_correlate_Rcore_current)

Path_correlate_Lcore_Replichore_current <- paste(Path_correlate_Lcore_replichore_up, "/G", sep = "")
dir.create(Path_correlate_Lcore_Replichore_current)
Path_correlate_Rcore_Replichore_current <- paste(Path_correlate_Rcore_replichore_up, "/G", sep = "")
dir.create(Path_correlate_Rcore_Replichore_current)
#======================================================#

#======== Bottom strand correlation directories ==========#
Path_correlate_RevComp_Chromosome_current <- paste(Path_correlate_RevComp_Chromosome_up, "/G", sep = "")
dir.create(Path_correlate_RevComp_Chromosome_current)

Path_correlate_RevComp_Lcore_current <- paste(Path_correlate_RevComp_Lcore_up, "/G", sep = "")
dir.create(Path_correlate_RevComp_Lcore_current)
Path_correlate_RevComp_Lcore_Replichore_current <- paste(Path_correlate_RevComp_Lcore_Replichore_up, "/G", sep = "")
dir.create(Path_correlate_RevComp_Lcore_Replichore_current)

Path_correlate_RevComp_Rcore_current <- paste(Path_correlate_RevComp_Rcore_up, "/G", sep = "")
dir.create(Path_correlate_RevComp_Rcore_current)
Path_correlate_RevComp_Rcore_Replichore_current <- paste(Path_correlate_RevComp_Rcore_Replichore_up, "/G", sep = "")
...
GWTC_Current <- GC4C_Gup
GWTC_Left_Current <- GC4C_Gup_Left
GWTC_Right_Current <- GC4C_Gup_Right
Rev_GWTC_Current <- GC4C_Gup_Comp
Rev_GWTC_Left_Current <- GC4C_Gup_Left_Comp
Rev_GWTC_Right_Current <- GC4C_Gup_Right_Comp

Mut_Matrix_Total <- Gup_Mut_Matrix_Total
Mut_Matrix_Left <- Gup_Mut_Matrix_Left
Mut_Matrix_Right <- Gup_Mut_Matrix_Right
Comp_Mut_Matrix_Total <- Gup_Comp_Mut_Matrix_Total
Comp_Mut_Matrix_Left <- Gup_Comp_Mut_Matrix_Left
Comp_Mut_Matrix_Right <- Gup_Comp_Mut_Matrix_Right
